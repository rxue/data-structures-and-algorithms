...
class Solution:
    def nearestExit(self, maze: list[list[str]], entrance: list[int]) -> int:
        ...
        while len(q) > 0:
            ...
            if not visitingVertex.isExit() and visitingVertex not in q: # in case the visiting vertex is exit, there is no need to append it to the queue for moving the next step
